---
layout: post
title: Inflation still too high. Are higher interest rates needed?
---

Inflation is once again [rising](https://edition.cnn.com/2024/04/10/economy/economic-storm-clouds-as-inflation-stalls/index.html) i[n the United](https://www.bls.gov/charts/consumer-price-index/consumer-price-index-by-category-line-chart.htm) States, despite [unprecedented](https://fred.stlouisfed.org/series/fedfunds) rate hikes last year. 
...
The debate among economists is heated, especially after Harvard professor Larry Summers harshly criticized the Fed for [having](https://youtu.be/ff2KOZF7M0s?si=A_Dtj-jEXA5mSUud&t=46) 
...
Simply put, the Fed, like any other central bank, believes that it can control inflation in two main ways. The first is by raising or lowering interest rates today and the second is by [communicating what it will do](https://www.ecb.europa.eu/ecb-and-you/explainers/tell-me/html/what-is-forward_guidance.en.html) with interest rates in the future. 
...
Perhaps even more importantly, while people’s inflation expectations for the next five years temporarily shot up to 2.5%, on average, they were then [again](https://fred.stlouisfed.org/series/EXPINF5YR) close to 2%. 
...
Of course, as we now know, things would soon take a turn for the worst. First, just the prospect of future interest rate cuts alone was enough [to drive financial markets higher than ever](https://www.cnbc.com/2024/01/18/stock-market-today-live-updates.html), which could potentially increase demand in the economy again as it makes people feel richer. But, even worse for the Fed, for the last three months alone, inflation consistently was higher than what its economis[ts had expected](https://www.bloomberg.com/news/articles/2024-04-10/us-core-cpi-rises-more-than-forecast-for-third-straight-month), and now even started to move up again, potentially risking that inflation expectations would soon follow. 
...
Specifically, in a recent [Bloomberg interview](https://www.youtube.com/watch?v=rdYZeOZPFLE&feature=youtu.be) Larry Summers gave four pieces of evidence why interest rates will need to increase. 

The first is that, despite the idea that high interest rates should reduce demand, [consumption](https://fred.stlouisfed.org/series/PCEC96) in the US economy is actually booming, growing much faster than in comparable economies like Europe, and Japan, where inflation is dropping. 

The second reason that professor Summers gave is that financial markets were once again [booming](https://fred.stlouisfed.org/series/SP500), even though one of the core ideas of increasing interest rates has been to slow down financial markets, which should then in turn decrease demand. 

Thirdly, professor Summers pointed out that the activity of traders in financial markets shows that they [now expect](https://www.globest.com/2024/01/03/money-markets-expect-rates-to-stay-high-for-years/?slreturn=20240414043204) that future interest rates will be well above 4%, whereas the Fed still officially expects them to go back to 2.6% in the long run. In other words, he points out that, on average, all of those smart analysts in financial markets agree with him that the Fed will see the light sooner or later and keep interest rates high. 

Finally, professor Summers pointed out that, [as I have recently discussed](https://www.moneymacro.rocks/2024-03-20-Fragmentation/) on this channel, global competition between countries like China, Russia, and the US is increasing, which has kept [government spending](https://fred.stlouisfed.org/series/FYFSGDA188S) on strategic industries and defense very high, which in turn is keeping demand very strong. Therefore, the Fed will have no choice but to keep interest rates higher if it wants to offset the increased demand that this government spending binge will inevitably bring. 

So yeah, some quite convincing arguments indeed, perhaps even to the Fed, given that they have n[ow signaled](https://www.reuters.com/markets/rates-bonds/fed-hold-rates-steady-inflation-dims-hopes-policy-easing-2024-05-01/) that they will not start cutting interest rates as quickly as they previously wanted. However, as you may have picked up… not cutting rates as quickly … still means that they think that 
...
Well, going through a lot of research from [Fed](https://www.frbsf.org/research-and-insights/data-and-indicators/supply-and-demand-driven-pce-inflation/) economists, and [other](https://www.ft.com/content/39af38ed-f493-4ad6-b6e3-3e4777ecdbbb?shareType=nongift) economists, I have found 4 main arguments as to why the Fed will NOT raise interest rates again soon. 

The first argument is that the recent inflation uptick was largely caused by a skyrocketing price of housing, which has, strangely enough, been made worse by interest rate hikes, so far. You see, recent research by the Financial Times Alphaville [blog](https://www.ft.com/content/39af38ed-f493-4ad6-b6e3-3e4777ecdbbb?shareType=nongift) shows that the latest inflation uptick has for a large part been caused by an uptick in the cost of housing, which is measured mostly as the [sum of](https://www.bls.gov/blog/2022/measuring-changes-in-shelter-prices-in-the-consumer-price-index.htm) what renters pay in rent, and what people who own a house WOULD hypothetically rent out their home for today. 
...
This is why in Europe and Japan, they don’t actually include this measure in inflation calculations. In fact, if they did, inflation [would be quite a bit higher](https://edition.cnn.com/2024/04/26/economy/us-europe-inflation-differences/index.html) in Europe. However, I actually agree with the Americans here, in that it is good to have inflation reflect higher house prices, rather than just looking at rent, because home price inflation is a really big part of inflation, for everyone who does NOT already own a home. 
...
The second argument why the Fed will not need to raise rates is luckily a bit simpler and that is that the other important prices, like [producer prices and wages](https://www.ft.com/content/39af38ed-f493-4ad6-b6e3-3e4777ecdbbb?shareType=nongift), that the Fed typically looks at, are signaling that inflation is still cooling down fast.  

Thirdly, while America’s economic growth numbers may look great on the surface, this might soon change [as](https://www.ft.com/content/39af38ed-f493-4ad6-b6e3-3e4777ecdbbb?shareType=nongift), fewer people a[re able to repay](https://www.stlouisfed.org/on-the-economy/2023/dec/share-americans-financial-distress-reaches-high-levels) their debts, and job see[kers report en mas](https://www.cnbc.com/2024/02/16/finding-a-job-is-getting-harder-even-in-a-strong-labor-market-heres-why.html)se that finding a job is again way more difficult, [despite](https://www.cnbc.com/2024/01/30/why-positive-labor-market-data-feels-awful-for-workers-job-seekers.html) what the numbers may suggest. 

And, finally, is it important to note that the Fed is not just looking at inflation, it also wants to prevent a financial crash, and given that there are still a [lot of worries](https://theconversation.com/why-economists-are-warning-of-another-us-banking-crisis-224092) about the health of the US banking system after the Silicon Valley Bank collapse last year and [worries about the sustainability of US government debt](https://www.axios.com/2024/02/08/us-government-debt-gdp-interest-costs) with interest rates around 5%, it could very well be that the Fed deems these threats too great to raise interest rates any time soon.
