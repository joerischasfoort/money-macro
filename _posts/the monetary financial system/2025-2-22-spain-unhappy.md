---
layout: post
title: If Spain is the world’s best economy, why are they so unhappy?
---

Spain is back! That is, [according to](https://www.economist.com/finance-and-economics/2024/12/10/which-economy-did-best-in-2024) The Economist, who crowned it the ‘rich’ world’s best economy in 2024, thanks to its rapid economic growth, low inflation, plummeting unemployment and amazing stock market performance. However, while [many](https://www.euronews.com/business/2024/03/29/spains-economy-thrives-why-its-growing-more-than-its-eu-rivals) media outlets agreed, Spaniards … seem to [disagree](https://www.statista.com/statistics/1382589/spain-opinion-economy/) wholeheartedly, with over 63% of Spaniards classifying their economy as bad or very bad in late 2024. 
...
1. What data did The Economist use to crown Spain Europe’s top performing economy? 
2. Question 2: Why did they use this data? And finally,
3. Question 3: did they use the CORRECT data?  
...
Variable 1: real GDP growth. The Economist [writes](https://www.economist.com/finance-and-economics/2024/12/10/which-economy-did-best-in-2024) that they chose this measure because it is 
...
This COULD explain why Spain’s economy looks good on paper, but feels bad to the people in it. In 2024, Spain’s [received](https://www.bbvaresearch.com/en/publicaciones/spain-growing-with-more-immigration/#:~:text=Immigration%20has%20become%20a%20driving,labor%2C%20linguistic%20and%20cultural%20integration.) a record number of migrants, especially from Latin America. More people means a bigger economy. Simple as that. But, that does NOT necessarily translate to people feeling good about the economy, see for example Canada, where people tend to feel like they are in a recession while the economy is still growing. But, if yo[u look at GDP per perso](https://data.worldbank.org/indicator/NY.GDP.PCAP.KN?end=2023&locations=CA&start=2005)n, you will that Canada is a[ctually in a recession](https://www.theglobeandmail.com/investing/markets/stocks/RY-T/pressreleases/30378248/economists-argue-canada-is-in-a-recession-based-on-per-capita-gdp-declining/).  
...
To find out, I mainly looked at the [Gini-coefficient](https://data.worldbank.org/indicator/SI.POV.GINI?end=2023&locations=ES&start=2005) for Spanish incomes, which is the most common metric economists use to measure average inequality. Sadly, though, the last data was for 2020. But, this showed inequality was moving in right direction and was at a level not s[o much crazier](https://data.worldbank.org/indicator/SI.POV.GINI?end=2023&locations=ES-IT-US&start=2005) than other countries. So, while, inequality could explain Spanish misery, it didn’t raise a huge red flag. 
...
So, here’s what I found. First, I had a look at similar surveys done in countries that have a reputation for having a better economy, like for example, the country where I was born: The [Netherlands](https://www.statista.com/statistics/547455/perceptions-of-the-economy-in-the-netherlands/). As you can see here, question 1 is wrong. People can be positive about their economy. After all, according to this poll in 2025, most Dutch people thought their economy was pretty good. But, strangely enough, the Dutch economy did not make it into the top 10 of the The Economist Ranking of 2024. 

So, could it be that perhaps, there’s something about Spanish culture. Were Spaniards always this negative about their economy? …. well. I don’t think so. You see, I found t[his poll from P](https://www.pewresearch.org/short-reads/2019/11/04/5-facts-about-public-opinion-in-spain-as-its-election-nears/#:~:text=Most%20Spaniards%20are%20discontent%20with%20the%20state%20of,while%20a%20majority%20%2857%25%29%20says%20it%20is%20bad.)ew research which clearly shows that before the massive crash of 2008, most Spaniards were actually pretty positive about their economy. 
...
So, we don’t care about GDP growth, we care about GDP per person. If we do that, and [compare, for example, the N](https://data.worldbank.org/indicator/NY.GDP.PCAP.CN?locations=ES-NL)etherlands versus Spain, we can see that now the surveys are starting to make sense. The average Spaniard was always poorer than the average Dutchman. But, his situation stagnated much more than that of the average Dutchman after 2008. 

Similarly, while unemployment was a[lways highe](https://data.worldbank.org/indicator/SL.UEM.TOTL.NE.ZS?end=2023&locations=ES-NL&start=1996)r in Spain, it has not yet returned to it’s 2008 low, while in the Netherlands it has. 

Similarly, while’s Spain’s stock market may have done well in 2024, it is still quite a [bit smaller](https://www.ceicdata.com/en/country/spain) [](https://companiesmarketcap.com/bolsas-y-mercados-espanoles/marketcap/)than that of it’s [tiny northe](https://www.ceicdata.com/en/country/netherlands)rn neighbor. And, while [inflation](https://data.worldbank.org/indicator/FP.CPI.TOTL?end=2023&locations=ES-NL&start=2007) and [private](https://www.imf.org/external/datamapper/PVD_LS@GDD/ESP/NLD) debt are lower in the Netherlands, government debt is quite a bit higher.  
...
So, if you truly want to understand what is going on in the global economy, do subscribe to the Economist, now at a 20% discount at [economist.com/moneymacro](http://economist.com/moneymacro) or using the link in the description or top comment below.